           ...
           // let currentInfos = infoList[stepNum]
                ...
                if(nameCheck == objName){
                    ...
                    if(highlighCheck != "none"){
                        ...
                        let specialPlanes = addSpecialPlaneNode(shapeCheck: array[2], widthOfObject: imageAnchor.referenceImage.physicalSize.width, heightOfObject: imageAnchor.referenceImage.physicalSize.height, highlighCheck: highlighCheck)
