...
class ArViewController: UIViewController, ARSCNViewDelegate {
    ...
    @IBOutlet weak var prevStep: UIButton!
            ...
            repeat{
                ...
                if(nameCheck == objName){
                    ...
                    if(textCheck == "none"){
                        ...
                        Textnode.position = SCNVector3(x:widthHoldr * 0.5, y:0.127, z:-0.015)
                    ...
                    let rotImg = image?.imageByMakingWhiteBackgroundTransparent()
                        let Imgnode = SCNNode(geometry: SCNPlane(width: imageAnchor.referenceImage.physicalSize.width * 0.32, height: imageAnchor.referenceImage.physicalSize.height * 0.5))
                        Imgnode.position = SCNVector3(x:0.0, y:0.06, z: heightHoldr * 0.65 )
                    ...
                    if(highlighCheck != "none"){
                            ...
                            case "corners":
                                ...
                                for _ in 0...2 {
                                    let airFilterPlane = SCNPlane(width: imageAnchor.referenceImage.physicalSize.width * 0.30 , height: imageAnchor.referenceImage.physicalSize.height * 0.30)
